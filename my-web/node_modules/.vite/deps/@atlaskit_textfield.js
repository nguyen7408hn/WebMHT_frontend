...
var AnalyticsListener = function(_Component) {
  ...
  var _super = _createSuper2(AnalyticsListener2);
  ...
  _createClass(AnalyticsListener2, [{
    key: "render",
    value: function render() {
      var children = this.props.children;
      return import_react3.default.createElement(esm_default.Provider, {
        value: this.contextValue
      }, children);
    }
  }]);
  return AnalyticsListener2;
...
var useAnalyticsContext = function useAnalyticsContext2() {
  return (0, import_react4.useContext)(esm_default);
};
...
var AnalyticsContext = function(_Component) {
  ...
  _createClass(AnalyticsContext4, [{
    ...
    value: function render() {
      var children = this.props.children;
      return import_react8.default.createElement(esm_default.Provider, {
        value: this.contextValue
      }, children);
    }
  }]);
...
var AnalyticsErrorBoundary = function(_Component) {
  ...
  _createClass(AnalyticsErrorBoundary2, [{
    ...
    value: function render() {
      ...
      var isModernContext = isModernContextEnabledEnv_default || fg("platform.analytics-next-use-modern-context_fqgbx");
      if (hasError) {
        if (ErrorComponent) {
          if (isModernContext) {
            return import_react12.default.createElement(ModernAnalyticsContext_default, {
              data
            }, import_react12.default.createElement(ErrorComponent, null));
          }
          return import_react12.default.createElement(LegacyAnalyticsContext_default, {
            data
          }, import_react12.default.createElement(ErrorComponent, null));
        }
        return null;
...
function usePlatformLeafEventHandler(_ref2) {
  var fn = _ref2.fn, action = _ref2.action, componentName = _ref2.componentName, actionSubject = _ref2.actionSubject, packageName = _ref2.packageName, packageVersion = _ref2.packageVersion, analyticsData = _ref2.analyticsData;
...
// node_modules/@atlaskit/textfield/dist/esm/styles.js
...
var getContainerTextBgAndBorderColor = function getContainerTextBgAndBorderColor2(appearance) {
  return {
...
var containerStyles = function containerStyles2(appearance, width) {
...
var inputStyles = function inputStyles2() {
  return {
...
var Textfield = (0, import_react19.forwardRef)(function(props, ref) {
  ...
  var handleOnFocus = usePlatformLeafEventHandler(_objectSpread4({
    fn: function fn(event) {
      onFocus && onFocus(event);
    },
    action: "focused"
  }, analyticsParams));
  var handleOnBlur = usePlatformLeafEventHandler(_objectSpread4({
    fn: function fn(event) {
      onBlur && onBlur(event);
    },
    action: "blurred"
  }, analyticsParams));
  var handleOnMouseDown = (0, import_react19.useCallback)(function(event) {
  ...
  var setInputRef = (0, import_react19.useCallback)(function(inputElement) {
  ...
  var containerStyles3 = (0, import_react19.useMemo)(function() {
